...
You may be familiar with doing programming exercises in online applications, such as [JS Fiddle](https://jsfiddle.net/) and [Codepen](http://codepen.io/). These applications allow you to write code using a web-based text editor. In other words, they allow you to write your code within your web browser. When you're ready to write your code on your own, you'll work in a stand-alone text editor.
